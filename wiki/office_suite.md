...
spreadsheet editing, presentations as well as [email](/wiki/email.md) and calendar software.
...
- [Apaches OpenOffice](https://www.openoffice.org/) is an open-source office suite for Windows and
    [Linux](/wiki/linux.md).
